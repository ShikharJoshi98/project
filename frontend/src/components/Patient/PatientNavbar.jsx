        ...
        <div className='bg-[#404858] w-full px-14 md:px-20 py-5 sticky top-0 z-50 flex items-center justify-between'>
            ...
            <div className='relative'>
                <ul className=' hidden lg:flex  items-center gap-6 text-white text-base'>
                    <a href='/dashboard-PATIENT' className="hover:text-gray-300 cursor-pointer ">Dashboard</a>
                ...
                {isOpen && <div className='absolute lg:hidden border-white border-1 rounded-md w-40 z-10 bg-[#404858] p-4 text-white  right-5'>                    
                    <p onClick={() => { navigate('/dashboard-PATIENT'); setOpen(false)}} className='text-center pt-4 hover:text-gray-300 cursor-pointer'>Dashboard</p>
                    <p onClick={() => { navigate('update-profile'); setOpen(false)}} className='text-center pt-4 hover:text-gray-300 cursor-pointer'>Update Profile</p>
                    <p onClick={() => { navigate('patient-appointment'); setOpen(false)}} className='text-center pt-4 hover:text-gray-300 cursor-pointer'>Appointments</p>
                    <p onClick={() => { navigate('upload-patient-image'); setOpen(false)}} className='text-center pt-4 hover:text-gray-300 cursor-pointer'>Update Records</p>
