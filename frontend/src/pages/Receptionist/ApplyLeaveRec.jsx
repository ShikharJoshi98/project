                        ...
                        <div className='flex md:flex-row flex-col md:items-start items-center gap-2 mt-10 w-full'>
                            <form onSubmit={handleSubmit} className='md:w-1/3 w-full space-y-5'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <h1>Start Date :</h1>
                                    <Input icon={Calendar} name="startDate" value={formValues.startDate} onChange={handleInputChange} type='Date' />
                                </div>
                                <div className='flex flex-col gap-2'>
                                    <h1>End Date :</h1>
                                    <Input icon={Calendar} name="endDate" value={formValues.endDate} onChange={handleInputChange} type='Date' />
                                </div>
                                <div className='mb-3 '>
