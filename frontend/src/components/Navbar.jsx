...
const Navbar = () => {
  ...
  return (
      <div className='bg-[#404858] min-w-full px-14 md:px-28 py-5  flex items-center justify-between'>
          ...
          <div className='relative'>
              <ul className=' hidden md:flex  items-center gap-8 text-white text-lg'>
                  ...
                  {isOpen && <div className='absolute md:hidden border-white border-1 rounded-md w-28 z-10 bg-[#404858] p-4 text-white  right-5 overflow-hidden"'>
