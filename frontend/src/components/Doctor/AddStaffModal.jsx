...
import { CiCalendar, CiHospital1, CiLock, CiMail, CiPhone, CiUser } from 'react-icons/ci';
...
const AddStaffModal = ({ setSubmit, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.data.message === "Employee Already Exists") {
            toast('Employee Username already exists.')
            return;
        } else {
            ...
            <div className="bg-[#e9ecef] max-h-[90vh] max-w-[70vw] overflow-y-auto flex flex-col w-full  rounded-xl p-6 md:p-10 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className='relative my-8 bg-white mx-auto md:max-w-[600px] w-full md:w-[40vw] h-auto p-8 border rounded-xl text-zinc-600 shadow-lg  text-sm flex flex-col gap-4' >
                    <div className='flex flex-col gap-2'>
                        <h1 >Full Name : </h1>
                        <Input icon={CiUser} type='text' required placeholder='Full Name*' name="fullname" onChange={handleInputChange} value={formValues.fullname} />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1 >Phone Number : </h1>
                        <Input icon={CiPhone} type='text' required placeholder='Phone*' name="phone" onChange={handleInputChange} value={formValues.phone} />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1 >Age : </h1>
                        <Input icon={CiUser} type='number' required placeholder='Age' name="age" onChange={handleInputChange} value={formValues.age} />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1>Email : </h1>
                        <Input icon={CiMail} type='email' required placeholder='Email*' onChange={handleInputChange} value={formValues.email} name="email" />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1>Username : </h1>
                        <Input icon={CiUser} type='text' required placeholder='Username*' onChange={handleInputChange} value={formValues.username} name="username" />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1>Password : </h1>
                        <Input icon={CiLock} type='text' required placeholder='Password*' onChange={handleInputChange} value={formValues.password} name="password" />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1>Gender : </h1>
                    ...
                    <div className='flex flex-col gap-2 '>
                        ...
                        <div className='relative w-full '>
                            ...
                            <select name="bloodGroup" id="Blood Type" onChange={handleInputChange} value={formValues.bloodGroup} className='py-2 pl-9 rounded-lg border border-gray-400 w-full focus:outline-none focus:ring-2 focus:ring-blue-300 text-zinc-900'>
                    ...
                    <div className='flex flex-col gap-2 '>
                        <h1>Address</h1>
                        <textarea placeholder='Add Address' required onChange={handleInputChange} value={formValues.address} name="address" className='w-full  h-10  pl-3 pr-3 py-2 font-normal  rounded-lg border border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300 text-zinc-900 placeholder-zinc-500 transition
            duration-200'></textarea>
                    </div>
                    <div className='flex flex-col gap-2 '>
                        <h1>Department</h1>
                        <Input placeholder='Add Department' onChange={handleInputChange} value={formValues.department} name="department" icon={CiHospital1} type='text' />
                    </div>
                    <div className='flex flex-col gap-2 '>
                        <h1>Salary</h1>
                    ...
                    <div className='flex flex-col gap-2 '>
                        <h1>Attendance</h1>
                        <Input placeholder='Attendance' icon={CiCalendar} onChange={handleInputChange} value={formValues.attendance} name="attendance" type='number' />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h1>Branch : </h1>
                        <div className='relative w-full '>
                            <div className='absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none'>
                                <FiMapPin className="size-4 text-blue-500" />
                            </div>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='relative w-full '>
                            <div className='absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none'>
                                <FaBriefcase className="size-4 text-blue-500" />
                            </div>
