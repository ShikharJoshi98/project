    ...
    return (
        <div className="bg-opacity-50 backdrop-filter backdrop-blur-xl bg-gradient-to-br from-blue-300 via-blue-400 to-sky-700 min-h-screen w-full overflow-hidden">
            <div className="bg-[#e9ecef] w-auto relative p-5 mx-10 my-6 rounded-lg">
                ...
                <h1 className='text-xl sm:text-3xl md:text-5xl text-center font-semibold mt-10 text-[#337ab7]'>ADD CONSULTATION CHARGES</h1>
                <button type="button" onClick={() => setPriceModal(true)} className="p-2 bg-blue-500 absolute top-10 right-5 text-white rounded-md cursor-pointer"><FaPlus size={24}/></button>
