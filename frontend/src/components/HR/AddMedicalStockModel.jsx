...
const AddMedicalStockModel = ({ onClose }) => {
    const { getMedicine, medicines, potencys, getPotency, addMedicineStock, stock } = useStore();    
  ...
  console.log(medicine, potency, quantity);
      useEffect(() => {
        getPotency();
      }, [getPotency]);
    async function handleSubmit(e) {
      e.preventDefault();
      console.log(medicine, potency, quantity);
        await addMedicineStock(medicine, potency, quantity);
