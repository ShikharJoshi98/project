    ...
    <div className='min-h-screen  bg-opacity-50 backdrop-filter backdrop-blur-xl bg-gradient-to-br from-blue-300 via-blue-400 to-sky-700   relative overflow-hidden' >
      {!isSubmitted ? (<form onSubmit={handleSubmit} className='mx-auto relative z-10 my-7 h-auto bg-white p-5 md:max-w-[430px] max-w-[80vw] border rounded-xl text-zinc-600 text-sm shadow-lg ' >
        ...
        <div className='mx-auto flex flex-col items-center relative z-10 my-7 h-auto bg-white p-5 md:max-w-[430px] max-w-72 border rounded-xl text-zinc-600 text-sm shadow-lg ' >
          ...
          <p onClick={() => navigate('/login')} className=' group mt-1 -ml-5 cursor-pointer text-blue-500 hover:text-blue-700 hover:underline flex items-center gap-1'> <RxDoubleArrowLeft /> Back to Login</p>
        </div>
      )}
    </div>
  )
