...
const SearchMedicine = ({pres,patientName}) => {
  ...
  return (
    <div className='shadow-sm bg-white text-gray-700 border text-[15px] font-semibold rounded-md border-gray-400 p-2 flex flex-wrap items-center justify-evenly'>
