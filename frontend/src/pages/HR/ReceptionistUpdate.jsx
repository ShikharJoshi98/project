        ...
        <h1 onClick={() => navigate('/staff-update')} className='text-2xl cursor-pointer '><FaAngleDoubleLeft /></h1>
          ...
          <div className='flex flex-col gap-4 m-auto '>
            ...
            <div className='w-full '>
              <button className='cursor-pointer block mx-auto bg-blue-400 text-lg font-semibold hover:text-gray-200 hover:bg-blue-600 hover:scale-101 text-white mt-7 w-52 p-2 rounded-full' type='submit' >
                Update
              </button>
            </div>
          </div>
