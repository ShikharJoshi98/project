            ...
            <div className='bg-opacity-50 backdrop-filter backdrop-blur-xl bg-gradient-to-br from-blue-300 via-blue-400 to-sky-700  min-h-screen  w-full overflow-hidden'>
                ...
                <div className='bg-[#e9ecef] w-auto p-5 mx-10 my-6 rounded-lg'>
                    ...
                    <div className='bg-white max-w-[410px]  mt-6 py-5 flex flex-col text-sm sm:text-lg gap-2 border-1 border-blue-400 rounded-md shadow-md mx-auto'>
                        <div className='flex justify-between px-2 sm:px-5'><p className='font-semibold'>Medicine Charges : </p><p>Rs 750</p></div>
                        <div className='flex justify-between px-2 sm:px-5'><p className='font-semibold'>Consultation Charges : </p><p>Rs 300</p></div>
                        <div className='flex justify-between px-2 sm:px-5'><p className='font-semibold'>Other Medicine : </p><p>-</p></div>
                        <div className='flex justify-between px-2 sm:px-5'><p className='font-semibold'>Total Amount : </p><p>Rs 1050</p></div>
                        ...
                        <div className='flex justify-between px-2 sm:px-5'><p className='font-semibold text-lg sm:text-2xl'>Amount to be Paid : </p><p className='text-lg sm:text-2xl'>Rs 1050</p></div>
