        ...
        <SidebarItem onClick={()=>navigate('/appointment-doctor')}   icon={<ClipboardPlus />} text={"APPOINTMENTS "} />
          ...
          <SidebarItem icon={<Briefcase />} text={"TODAYS COLLECTIONS"} />
            ...
            <div>
              ...
              <Input icon={Search} type="text"  name="name"  placeholder='Enter Disease Name or description'    required />
            </div>
        ...
        <thead className=''>
          <tr className=" bg-blue-500 text-white text-lg">
            ...
            <th className="py-2 px-4 border">PDF</th>
                ...
                <tbody>
                  {
                    HomeoDisease.map((disease, idx) => (
                      <tr key={idx} className=" bg-blue-100  ">
                        <td className="py-3 px-4 border text-center">{ idx+1}</td>
                        <td className="py-3 px-4 border text-center">{ disease?.name}</td>
                         <td className="py-3 px-4 border text-center">{ disease?.description}</td>
