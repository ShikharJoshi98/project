                ...
                <div className='flex sm:flex-row flex-col items-center sm:items-start w-full gap-10 mt-10 mb-2 pr-5'>
                    <form onSubmit={handleSubmit} className='sm:w-1/2 w-full mt-10 space-y-5'>
                        <div className='flex flex-col gap-2'>
                            <h1>Mention Here</h1>
                            <Input icon={CiCirclePlus} type='text' value={disease} onChange={(e) => setDisease(e.target.value)} required placeholder='Enter Symptoms' />
                        </div>
                            ...
                            {list.map((investigation, index) => (
                                <div key={index}>
                                    <div className='flex items-center justify-between px-10'>
                                        ...
                                        <FaTrash onClick={() => deleteData(investigation?._id)} />
                                    </div>
