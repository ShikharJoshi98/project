        ...
        <form onSubmit={handleSubmit} className='mx-auto relative z-10 my-8 h-auto bg-white p-8 md:max-w-[500px] max-w-72 border rounded-xl text-zinc-600 text-sm shadow-lg'>
          ...
          <div className='flex flex-col gap-4 m-auto items-start'>
            ...
            <div className='relative mt-2   w-full '>
              ...
              <select onChange={(e) => {const selectBranch = e.target.value; setBranch(selectBranch);}} name="branch" required id="Branch" className='py-2 pl-9 rounded-lg border border-gray-400 w-full focus:outline-none focus:ring-2 focus:ring-blue-300 text-zinc-900'>
