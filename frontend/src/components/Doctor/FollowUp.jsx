...
const FollowUp = () => {
    ...
    return (
        <div>
            ...
            <button onClick={() => navigate(`/appointment-details/${location.id}/history-details`)} className='block cursor-pointer text-lg font-semibold mx-auto py-2 px-4 rounded-md bg-blue-500 text-white'>History Details</button>
