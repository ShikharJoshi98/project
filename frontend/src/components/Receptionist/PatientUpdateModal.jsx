            ...
            <div className="bg-[#e9ecef] max-h-[90vh] max-w-[80vw] overflow-y-auto   flex flex-col w-full  rounded-xl p-6 md:p-10 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className='z-10 my-8 mx-auto bg-white p-8 sm:max-w-[50vw] w-full border rounded-xl text-zinc-800 text-sm shadow-lg ' >
                    ...
                    <div className='flex flex-col gap-4 m-auto '>
                        ...
                        <div className='flex flex-col gap-2 '>
                            <h1>Qualification*</h1>
                            <Input icon={GraduationCap} onChange={handleInputChange} name="qualification" value={formValues.qualification} type='text' placeholder='Gender'  />
                        </div>
                        <div className='flex flex-col gap-2 '>
                            <h1>Occupation*</h1>
                            <Input icon={BriefcaseBusiness} onChange={handleInputChange} name="occupation" value={formValues.occupation} type='text' placeholder='Gender'  />
                        </div>
                        <div className='flex flex-col gap-2'>
