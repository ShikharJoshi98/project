        ...
        <div>
            ...
            <div className='bg-opacity-50 backdrop-filter backdrop-blur-xl bg-gradient-to-br from-blue-300 via-blue-400 to-sky-700 min-h-screen w-full overflow-hidden'>
                ...
                <div className='bg-[#e9ecef] w-auto p-5 mx-10 my-6 rounded-lg'>
                    <p className='text-red-500 mb-5 font-semibold'>For Appointments Contact Us at Dombivli Branch - 8080899990</p>
                    ...
                    <h1 className='p-1 text-center font-semibold'>(Call Us Dombivli 8080899990 - Book an Appointment for the Next Vist)</h1>
                    <div className="overflow-x-auto mt-6 rounded-lg">
                        <table className="min-w-full border border-gray-300 bg-white shadow-md ">
                            <thead className="bg-[#337ab7] whitespace-nowrap text-white">
                                <tr >
