...
const BriefMindSymptom = ({ complaint }) => {
  ...
  return (
    <div>
      <h1 className='sm:text-xl bg-blue-500 flex items-center justify-center gap-5 text-white text-lg font-semibold  py-2'>Frequently Asked Questions <ClipboardPlus onClick={() => setFaqModalIsOpen(true)} className='cursor-pointer' /></h1>
