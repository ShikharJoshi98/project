...
const Contact = () => {
  ...
  return (
    <div >
        <div className='flex flex-col  p-6 items-center gap-12 max-w-[326px]  md:max-w-[760px]  lg:max-w-[900px] h-auto mt-20 bg-white mx-auto shadow-gray-700 shadow-lg rounded-lg'>
          ...
          <h1 className='text-2xl font-semibold text-slate-800'>"Call Us"</h1>
