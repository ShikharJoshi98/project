...
const Login = () => {
  ...
  return (
    <div className='min-h-screen  bg-gradient-to-br from-blue-400 via-[#4a9acc] to-blue-900  relative overflow-hidden' >
      ...
      <form className='mx-auto relative z-10 mt-8 h-auto bg-white p-8 md:max-w-[380px] max-w-72 border rounded-xl text-zinc-600 text-sm shadow-lg ' >
          ...
          {  showPassword ?
            ...
            <button  onClick={handleSubmit} className='mx-auto font-semibold cursor-pointer bg-blue-400 text-lg hover:text-gray-200 hover:bg-blue-600 hover:scale-101 text-white mt-5 w-52 p-2 rounded-full' type='submit'>Login</button>
