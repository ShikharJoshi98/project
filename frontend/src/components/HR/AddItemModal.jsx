        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="bg-white p-5 rounded-lg w-full">
            <form onSubmit={additem}>
              ...
              <Input onChange={(e) => setitem(e.target.value)} icon={FaPlus} type="text" value={NewItem} placeholder="Mention Item Name"/>
          ...
          <div className="bg-white p-5 rounded-lg w-full">
            <form onSubmit={addunit}>
              ...
              <Input onChange={(e) => setunit(e.target.value)} icon={FaPlus} type="text" value={NewUnit} placeholder="Mention Unit Name"/>
              <button type="submit" className="bg-blue-500 w-full transition-all duration-300 cursor-pointer hover:bg-blue-600 py-2 rounded-lg mt-3 text-white">Add</button>
            </form>
          </div>
        </div>
