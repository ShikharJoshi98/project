...
const ThermalReaction = ({ complaint }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.post(`${DOC_API_URL}/add-thermal-reaction-patient/${id}`, {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className='sm:text-xl bg-blue-400 text-white text-lg font-semibold mt-10 text-center py-2'>{complaint} Added
                </h1>
...
export default ThermalReaction