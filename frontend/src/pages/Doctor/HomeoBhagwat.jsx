        ...
        <div className='bg-gradient-to-br from-blue-300 via-blue-400 to-sky-700 min-h-screen overflow-hidden p-8 w-full'>
            ...
            <div className='bg-[#e9ecef] p-5 rounded-lg'>
                ...
                <div className='sm:flex grid grid-cols-2 mt-5 sm:flex-row text-stone-800 font-semibold  gap-2 sm:gap-9 justify-center items-center md:gap-9 text-[10px] sm:text-base'>
                    <button onClick={() => setHomeoBhagwatSection('medicine')} className={`cursor-pointer border-1 hover:scale-98 transition-all duration-300 ${homeoBhagwatSection === 'medicine' ? 'bg-blue-500 text-white' : 'bg-blue-300 text-black'} p-2 hover:bg-blue-600 hover:text-white rounded-lg`}>MEDICINE NAME</button>
                    <button onClick={() => setHomeoBhagwatSection('disease')} className={`cursor-pointer border-1 hover:scale-98 transition-all duration-300 ${homeoBhagwatSection === 'disease' ? 'bg-blue-500 text-white' : 'bg-blue-300 text-black'} p-2 hover:bg-blue-600 hover:text-white rounded-lg`}>DISEASE NAME</button>
                    <button onClick={() => setHomeoBhagwatSection('redline')} className={`cursor-pointer border-1 hover:scale-98 transition-all duration-300 ${homeoBhagwatSection === 'redline' ? 'bg-blue-500 text-white' : 'bg-blue-300 text-black'} p-2 hover:bg-blue-600 hover:text-white rounded-lg`}>RED LINE SYMPTOMS</button>
                </div>
