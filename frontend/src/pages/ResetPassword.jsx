			...
			<div className='p-8'>
                ...
                <h1 className='text-3xl  font-semibold mb-5 text-center'><span className='text-blue-400'> RESET</span> PASSWORD</h1> 
					...
					<button
						...
						className='mx-auto font-semibold mt-2 cursor-pointer bg-blue-400 text-lg hover:text-gray-200 hover:bg-blue-600 hover:scale-101 text-white  w-52 p-2 rounded-full'
						disabled={isLoading}
					>
